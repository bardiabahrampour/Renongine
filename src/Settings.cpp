...
void Settings::get_settings() {
  ...
  this->graphics_setting =
      get_enum(this->get_value(GENERAL, GRAPHICS).as_int());
}
...
Quality Settings::get_enum(int i) {
  switch (i) {
    case 1:
      return Quality::LOW;
      break;
